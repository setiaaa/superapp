...
const CardList = ({ item, token, selectedFilter }) => {
  ...
  return (
    <View style={[styles.card, { backgroundColor: theme.card }]}>
      {/* BAGIAN 1: Area yang bisa diklik untuk melihat detail */}
...
const styles = StyleSheet.create({
  ...
  cancelButton: {
    backgroundColor: "#FF1717", // Latar belakang tombol tetap merah
    borderRadius: 8,
    paddingVertical: 12,
    alignItems: "center",
    marginTop: 12,
  ...
  cancelButtonText: {
    color: "#FFFFFF", // Warna teks diatur di sini menjadi putih
    fontSize: 16,
    fontWeight: "bold",
  },
});
